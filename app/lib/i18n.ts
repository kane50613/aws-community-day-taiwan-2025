export const messages = {
  ...
  en: {
    ...
    "hero_section.survey": "Post-event Survey",
    ...
    "current_session.button": "Go to Current Session",
  ...
  ja: {
    ...
    "hero_section.survey": "イベント後のアンケート",
    ...
    "current_session.button": "現在のセッションへ",
  ...
  kr: {
    ...
    "hero_section.survey": "이벤트 후 설문조사",
    ...
    "current_session.button": "현재 세션으로 이동",
